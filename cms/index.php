...
<?php if(isset($_GET['a']) && $_GET['a'] == 'login' OR !isset($_GET['a'])) { ?>
  <?php if (isset($_GET['wp']) && $_GET['wp'] == 1) 
      echo '<h1 class="heading">Wrong Password</h1>';
    else echo '<h1 class="heading">Login</h1>';
  ?>
...
<?php
  } else if(isset($_GET['a']) && $_GET['a'] == 'newArticle') { // todo: fix this password placeholder shit
?>
...
<?php if(isset($_GET['a']) && $_GET['a'] == 'newArticle') {  ?>
